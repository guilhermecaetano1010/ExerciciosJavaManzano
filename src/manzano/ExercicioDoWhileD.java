...
public class ExercicioDoWhileD {

	public static void main(String[] args) {
        long numeroGraos = 1;
        long somatorio = numeroGraos;
        int contador = 1;
        ...
        System.out.println("O somatório de grãos de trigo em um tabuleiro de xadrez é: " + somatorio);
	}
...
grãos (tendo-se então 15 grãos) até atingir o sexagésimo quarto (64º) quadro. Utilize variáveis do 
